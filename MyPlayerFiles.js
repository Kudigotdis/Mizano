...
window.MyPlayerFiles = (function () {
    ...
    async function init(container) {
        ...
        target.innerHTML = _buildHeader() + `<div id="mpf-content-wrap" style="padding-bottom:120px;">
    ...
    async function refresh() {
        ...
        if (!_playerFiles || _playerFiles.length === 0) {
            ...
            wrap.innerHTML = _buildFilterChips() + _playerFiles.map(pf => _buildCard(pf)).join('') + _buildBottomActions();
            _attachListeners();
        }
    }
    ...
    function _buildHeader() {
        ...
        <div class="overlay-header sticky-top" style="display:flex;align-items:center;padding:14px 16px;background:#fff;border-bottom:1px solid #f0f0f0;position:sticky;top:0;z-index:100;">
            ...
            <h2 style="flex:1;text-align:center;font-size:1rem;font-weight:700;margin:0;color:#1a1a1a;">Profiles</h2>
    ...
    function _buildEmptyState() {
        return `<div style="padding:60px 24px;text-align:center;color:#666;">
            ...
            <h3 style="color:#1a1a1a;margin:0 0 12px;font-size:1.2rem;">No Profiles added yet.</h3>
    ...
    function _buildBottomActions() {
        ...
        <div style="position:fixed; bottom:20px; left:0; right:0; display:flex; justify-content:center; pointer-events:none; z-index:1000;">
            <button onclick="window.AddActionRouter.openForm('player_file')" 
