...
window.MyBusiness = (function () {
    ...
    async function init() {
        ...
        detailView.innerHTML = _buildHeader() + `<div id="mb-content-wrap" style="padding-bottom:120px;">
    ...
    async function refresh() {
        ...
        if (!_businesses || _businesses.length === 0) {
            ...
            wrap.innerHTML = _buildFilterChips() + _businesses.map(b => _buildBusinessCard(b)).join('');
            _attachListeners();
        }
    }
    ...
    function _buildHeader() {
        ...
        <div class="overlay-header sticky-top" style="display:flex;align-items:center;padding:14px 16px;background:#fff;border-bottom:1px solid #f0f0f0;position:sticky;top:0;z-index:100;">
            ...
            <button onclick="window.AddActionRouter.openForm('business')" style="background:none;border:none;color:#1a73e8;font-weight:600;font-size:0.9rem;cursor:pointer;">+ List</button>
        </div>
        <style>
    ...
    function _buildEmptyState() {
        return `<div style="padding:60px 24px;text-align:center;color:#666;">
            ...
            <h3 style="color:#1a1a1a;margin:0 0 12px;font-size:1.2rem;">No Business Listed</h3>
