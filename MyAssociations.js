...
window.MyAssociations = (function () {
    ...
    async function init() {
        ...
        detailView.innerHTML = _buildHeader() + `<div id="ma-content-wrap" style="padding-bottom:120px;">
    ...
    async function refresh() {
        ...
        if (!_associations || _associations.length === 0) {
            ...
            wrap.innerHTML = _buildFilterChips() + _associations.map(a => _buildCard(a, userId)).join('');
            _attachListeners();
        }
    }
    ...
    function _buildHeader() {
        ...
        <div class="overlay-header sticky-top" style="display:flex;align-items:center;padding:14px 16px;background:#fff;border-bottom:1px solid #f0f0f0;position:sticky;top:0;z-index:100;">
            ...
            <h2 style="flex:1;text-align:center;font-size:1rem;font-weight:700;margin:0;color:#1a1a1a;">My Associations</h2>
            <button onclick="window.AddActionRouter.openForm('association')" style="background:none;border:none;color:#1a73e8;font-weight:600;font-size:0.9rem;cursor:pointer;">+ Register</button>
        </div>
        <style>
    ...
    function _buildEmptyState() {
        return `<div style="padding:60px 24px;text-align:center;color:#666;">
            ...
            <h3 style="color:#1a1a1a;margin:0 0 12px;font-size:1.2rem;">No Associations</h3>
